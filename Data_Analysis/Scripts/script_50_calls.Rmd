...
strumat[1,5] <- 0
strumat[,6] <- 0
strumat[6,] <- 0#Define which transitions is not possible, 
#here it is not possible to begin the sequence with a C-call, BS-call (E) and a AS-call (D) since 
#the first one is not an alarm call and the other ones are present later in the sequence
#Plus, NA calls are not informative so I set their probabilities to 0
